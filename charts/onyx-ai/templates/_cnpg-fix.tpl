{{/*
Override CNPG cluster chart's externalClusters template to fix null value bug.
The upstream template outputs "externalClusters:" even in standalone mode,
which becomes null and fails CRD validation.
*/}}
